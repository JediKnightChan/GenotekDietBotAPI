"""
Django settings for GenotekDietBotAPI project.
...
MIDDLEWARE = [
    ...
    'generic.middleware.parse_json_middleware.JSONMiddleware'
]

ROOT_URLCONF = 'GenotekDietBotAPI.urls'
...
WSGI_APPLICATION = 'GenotekDietBotAPI.wsgi.application'
